...
- `src/core/currentClamp.js`: detección y métricas PSP en ventanas relativas a estímulos declarados.
...
- motor sintético y detector PSP deterministas descritos en [`PSP_TUTOR_ARCHITECTURE.md`](../../docs/electrophysiology/PSP_TUTOR_ARCHITECTURE.md) y [`PSP_DETECTOR_VALIDATION.md`](../../docs/electrophysiology/PSP_DETECTOR_VALIDATION.md); permanecen separados de la interfaz pública durante validación;
- perfil experimental de current clamp conforme a [`CURRENT_CLAMP_SPEC.md`](../../docs/electrophysiology/CURRENT_CLAMP_SPEC.md), pendiente de revisión con registros reales antes de integrarlo;
